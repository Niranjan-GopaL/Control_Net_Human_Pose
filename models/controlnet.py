    ...
    def forward(self, x, t, hint, scale=1.0):
        ...
        for idx, down in enumerate(self.control_copy_unet.downs):
            ...
            control_copy_unet_down_outs.append(
                scale * self.control_copy_unet_down_zero_convs[idx](control_copy_unet_out)
            )
        ...
        for idx in range(len(self.control_copy_unet.mids)):
            ...
            train_unet_out += scale * self.control_copy_unet_mid_zero_convs[idx](control_copy_unet_out)
